...
BACKGROUND = 'gallery/sprits/background.png'
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird by CodeWithAnuja')
    ...
    GAME_SPRITES['message'] =pygame.image.load('gallery/sprits/welcome.jpg').convert_alpha()
